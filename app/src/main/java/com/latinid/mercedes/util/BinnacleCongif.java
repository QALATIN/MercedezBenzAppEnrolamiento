...
public class BinnacleCongif {
    ...
    /**
     * SE ENVIO AL SERVIDOR ERRORES Y MOVIMIENTOS IMPORTANTES
     * @param tag
     * @param typeLog
     * @param msg
     * @param ref
    ...
    /**
     * Se guarda localmente un LOG INTERNO, registrando los errores y los MOVIMIENTOS más importantes.
     * @param context
     * @param json
     */
