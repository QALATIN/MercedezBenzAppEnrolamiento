...
public class SignatureBackWok extends Worker {
    ...
    private static final String TAG = "SignatureBackWok.class";
    ...
    public Result doWork() {
        ...
        try {
            ...
            BinnacleCongif.writeLog(TAG,1, "Error firmando aviso de privacidad Asincronamente -> function: doWork()", "Error: "+e.getLocalizedMessage(), getApplicationContext());
            DatosRecolectados.docSignatureFinish = "nosigned";
            e.printStackTrace();
    ...
    private JSONObject createJsonAddSign(String reference, String firma) {
        try {
            ...
            BinnacleCongif.writeLog(TAG,1, "Error creando JSON -> function: createJsonAddSign()", "Error: "+e.getLocalizedMessage(), getApplicationContext());
            e.printStackTrace();
            return null;
        }
    }
    ...
    private JSONObject generarFirmaSeguriData(JSONObject json) {
        try {
            ...
            BinnacleCongif.writeLog(TAG,1, "Error consultando POST /FileSend -> function: generarFirmaSeguriData()", "Error: "+e.getLocalizedMessage(), getApplicationContext());
            e.printStackTrace();
            return null;
        }
    }
    ...
    private String tokenRequestSignature() {
        try {
            ...
            BinnacleCongif.writeLog(TAG,1, "Error consultando TOKEN en POST http://10.10.8.211/API/GetToken -> function: tokenRequestSignature()", "Error: "+e.getLocalizedMessage(), getApplicationContext());
            e.printStackTrace();
            return null;
        }
    }
    ...
    private JSONObject crearJSONPDFSeguriData(String privacyNotice, String nombre, String paterno, String materno) {
        try {
            ...
            BinnacleCongif.writeLog(TAG,1, "Error generando JSON -> function: crearJSONPDFSeguriData()", "Error: "+e.getLocalizedMessage(), getApplicationContext());
    ...
    private String createPdfPrivacy() {
        try {
           ...
           Header headerHandler = new Header("TONY");
            ...
            BinnacleCongif.writeLog(TAG,1, "Error creando documento PDF de aviso de privacidad -> function: createPdfPrivacy()", "Error: "+e.getLocalizedMessage(), getApplicationContext());
           e.printStackTrace();
            return "";
        }
    }
