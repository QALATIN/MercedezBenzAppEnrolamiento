...
public class UtilsPDF {
    ...
    private static final String TAG = "UtilsPDF.class";
        ...
        try {
            ...
            for (TablaPDFModel tablaPDFModel : infotabla) {
                ...
                try {
                    ...
                    BinnacleCongif.writeLog(TAG,1, "Error llenando tabla TablaPDFModel tablaPDFModel -> function: generarPDFIdentificacion()", "Error: "+e.getLocalizedMessage(), context);
                    e.printStackTrace();
                }
                contTables++;
            }
            ...
            BinnacleCongif.writeLog(TAG,1, "Error creando PDF-> function: generarPDFIdentificacion()", "Error: "+e.getLocalizedMessage(), context);
            e.printStackTrace();
            return null;
        }
    }
    ...
    public static String generarPDFIdentificacionConChip(File filesDir, Context context, PersonaModel personaModel, IdentificacionModel identificacionModel) {
        try {
            ...
            BinnacleCongif.writeLog(TAG,1, "Error creando PDF-> function: generarPDFIdentificacionConChip()", "Error: "+e.getLocalizedMessage(), context);
            e.printStackTrace();
            return null;
        }
    }
