...
public class ViewPdfFragment extends DialogFragment {
    ...
    private static final String TAG = "ViewPdfFragment.class";
    ...
    private File saveImage(final Context context, final String imageData) {
        ...
        try {
            ...
            BinnacleCongif.writeLog(TAG,1, "Error guardando pdf temp para mostrar -> function: saveImage()", "Error: "+e.getLocalizedMessage(), requireContext());
            e.printStackTrace();
            return null;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            BinnacleCongif.writeLog(TAG,1, "Error generando iamgen de pdf -> function: saveImage()", "Error: "+e.getLocalizedMessage(), requireContext());
