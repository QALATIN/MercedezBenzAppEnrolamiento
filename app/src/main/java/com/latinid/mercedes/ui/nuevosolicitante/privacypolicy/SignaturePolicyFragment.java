...
public class SignaturePolicyFragment extends Fragment {
    ...
    private static final String TAG = "SignaturePolicy.class";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.buttonBack.setOnClickListener(view -> {
            ((Main3Activity) getActivity()).removerFragment();
        });
        buttonNext();
            ...
            executor.execute(() -> {
                ...
                try {
                   ...
                   /* Data.Builder data = new Data.Builder();
                    ...
                    BinnacleCongif.writeLog(TAG,1, "Error guardando firma -> function: buttonNext()", "Error: "+e.getMessage()+"|"+e.getLocalizedMessage()+"|"+e.getCause().getMessage(), requireContext());
                    e.printStackTrace();
                }finally {
                    dataBase.close();
                }
    ...
    private String readTxt(String file) {
        ...
        try {
            ...
            BinnacleCongif.writeLog(TAG,1, "Error leyendo firma vacía -> function: readTxt()", "Error: "+e.getLocalizedMessage(), requireContext());
            e.printStackTrace();
            return null;
        } finally {
            if (reader != null) {
