...
class CapNfcActivity : AppCompatActivity(), NfcTagReadingListener {
    ...
    private val TAG = "CapNfcActivity.class"
    ...
    override fun onError(error: AcuantError) {
        BinnacleCongif.writeLog(
            TAG,
            1,
            "Error leyendo chip pasaporte -> function: onError()",
    ...
    override fun onNewIntent(intent: Intent) {
        ...
        AcuantEchipReader.readNfcTag(this, intent, DatosRecolectados.docNumber.trim { it <= ' ' }, DatosRecolectados.dob,
            DatosRecolectados.doe, performOzoneAuthentication = true, tagListener = this)
