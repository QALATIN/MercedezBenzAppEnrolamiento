...
public class DocsFragment extends Fragment {
    ...
    private static final String TAG = "DocsFragment.class";
    ...
    private void mostrarAdjunto(Uri uri, String doc){
        try {
            ...
            BinnacleCongif.writeLog(TAG,1, "Error mostrando adjunto -> function: mostrarAdjunto()", "Error: "+e.getLocalizedMessage(), requireContext());
    ...
    private  String getMimeType(Uri uri) {
      try {
          ...
          BinnacleCongif.writeLog(TAG,1, "Error trayendo tipo -> function: getMimeType()", "Error: "+e.getLocalizedMessage(), requireContext());
          e.printStackTrace();
          return null;
      }
    }
    ...
    private void accionarCamara() {
        ...
        if (cameraIntent.resolveActivity(requireActivity().getPackageManager()) != null) {
            ...
            try {
                ...
                BinnacleCongif.writeLog(TAG,1, "Error createImageFile -> function: accionarCamara()", "Error: "+e.getLocalizedMessage(), requireContext());
    ...
    private String convertirUritoStringB64(Uri uri) {
        try {
            ...
            BinnacleCongif.writeLog(TAG,1, "Error convirtiendo Uri a base64 -> function: convertirUritoStringB64()", "Error: "+e.getLocalizedMessage(), requireContext());
            e.printStackTrace();
            return null;
        }
    }
