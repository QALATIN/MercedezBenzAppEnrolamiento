...
public final class FragmentSendlogBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentSendlogBinding(@NonNull RelativeLayout rootView, @NonNull MaterialButton adjuntar,
  ...
  @NonNull
  public static FragmentSendlogBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentSendlogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_sendlog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentSendlogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSendlogBinding((RelativeLayout) rootView, adjuntar, cerrar, imgGif,
          subtitulo, titulo);
    }
