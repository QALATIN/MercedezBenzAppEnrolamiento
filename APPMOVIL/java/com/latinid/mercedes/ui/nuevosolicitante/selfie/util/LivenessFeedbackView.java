package com.latinid.mercedes.ui.nuevosolicitante.selfie.util;
...
/**
 * A helper class for updating the feedback UI
 *
 * Created by stoth on 11/7/2017.
 */

public class LivenessFeedbackView implements FeedbackCallback, DevicePositionCallback, CanvasUpdateCallback {
    ...
    private boolean mCheckPhonePosition;

    public LivenessFeedbackView(final Activity activity, LivenessFragment act) {
    ...
    private void drawRaceTrackNew(FeedbackResult feedbackResult, float scaleValue, boolean useColor, int backgroundAlpha) {
        ...
        if (useColor == false) {
            boolean positionMode = ui.getCheckPhonePosition();
            ...
            if(mCheckPhonePosition)
                ...
                greenOval = feedbackResult.isCompliant();
